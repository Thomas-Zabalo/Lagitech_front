    ...
    <>
      ...
      <div className="flex flex-col lg:flex-row gap-3 mb-6">
        <input
          ...
          className="flex-1 bg-gray-700 rounded-full px-4 py-2 text-white placeholder-white/60"
          value={newBaby.name}
        ...
        <input
          ...
          className="w-40 bg-gray-700 rounded-full px-4 py-2 text-white placeholder-white/60"
          value={newBaby.gamesPlayed}
          onChange={(e) => setNewBaby({ ...newBaby, gamesPlayed: Number(e.target.value) })}
        />
        <select
          className="bg-gray-700 rounded-full px-4 py-2 dark:text-white dark:bg-gray-700"
